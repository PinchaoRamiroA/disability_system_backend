...
func toIncapacidadModel(i *domain.Incapacidad) *incmodels.IncapacidadModel {
	return &incmodels.IncapacidadModel{
		...
		FechaTranscripcion:        i.FechaTranscripcion,
		TranscritoPor:             i.TranscritoPor,
		ObservacionesTranscripcion: i.ObservacionesTranscripcion,
		FechaLimiteTranscripcion:  i.FechaLimiteTranscripcion,
...
func toIncapacidadDomain(m *incmodels.IncapacidadModel) *domain.Incapacidad {
	incapacidad := &domain.Incapacidad{
		...
		FechaTranscripcion:        m.FechaTranscripcion,
		TranscritoPor:             m.TranscritoPor,
		ObservacionesTranscripcion: m.ObservacionesTranscripcion,
		FechaLimiteTranscripcion:  m.FechaLimiteTranscripcion,
		EstadoTranscripcion:       m.EstadoTranscripcion,
	}
